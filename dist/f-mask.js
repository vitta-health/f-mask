(function (global, factory) {
  ...
  (global = global || self, factory(global.VueFMask = {}));
  ...
  var _defaultMaskReplacers;

  var NEXT_CHAR_OPTIONAL = {
    __nextCharOptional__: true
  };
  var NEXT_CHAR = '?';
  var BACK_CHAR_OPTIONAL = {
  ...
  function updateMask(el, mask) {
    var _options$get = options.get(el),
        optional = _options$get.optional;

    var _mask$split$reverse = mask.split(BACK_CHAR).reverse(),
        _mask$split$reverse2 = _toArray(_mask$split$reverse),
        base = _mask$split$reverse2[0],
    ...
    var parsedMask = stringMaskToRegExpMask(base);
    options.partiallyUpdate(el, {
      mask: parsedMask,
      base: base
    });
  ...
  function updateValue(el) {
    ...
    var _options$get3 = options.get(el),
        mask = _options$get3.mask;
